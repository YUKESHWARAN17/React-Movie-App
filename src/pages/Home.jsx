...
const [search, setSearch] = useState("")
  ...
  useEffect(() => {
    ...
    let url = `https://api.themoviedb.org/3/movie/popular?page=${page}&api_key=7facf11aee2da010ab5ca0261c8b58f1`
    ...
    <div className="p-4 pt-16">
        ...
        top-16 left-1/2 transform -translate-x-1/2 z-10" onChange={(e) => setSearch(e.target.value)}
        />
